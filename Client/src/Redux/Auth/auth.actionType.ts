export const SIGNIN_SUCCESS: string = 'auth/SIGIN/SUCCESS';
export const SIGNUP_SUCCESS: string = 'auth/SIGNUP/SUCCESS';
export const SIGNOUT_SUCCESS: string = 'auth/SIGNOUT/SUCCESS';

export const AUTH_LOADING: string = 'auth/loading';
